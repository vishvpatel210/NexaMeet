...
export const LiveRecordingModal = ({ isOpen, targetMeetingId, onClose, onRecordingSaved }) => {
    ...
    const [spectrumData, setSpectrumData] = useState(new Array(16).fill(15));
        ...
        try {
            ...
            const updateSpectrum = () => {
                if (analyserRef.current && !isPaused) {
                    ...
                    const bars = Array.from(dataArray.slice(0, 16)).map((val) => Math.max(10, Math.min(100, Math.round((val / 255) * 100))));
    ...
    return (_jsx("div", { style: {
            ...
            userSelect: 'none'
                ...
                alignItems: 'center'
            }, children: [_jsxs("div", { style: { width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.5rem' }, children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '0.5rem', color: '#F43F5E', fontSize: '0.85rem', fontWeight: 600 }, children: [_jsx("div", { style: {
                                        width: '8px',
                                        height: '8px',
                                        borderRadius: '50%',
                        ...
                        width: '100%',
                        marginBottom: '1.5rem'
                    }, children: spectrumData.map((val, idx) => (_jsx("div", { style: {
                            width: '6px',
                            height: `${val}%`,
                        ...
                        letterSpacing: '0.05em'
                    }, children: formatTimer(secondsElapsed) }), _jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '1.5rem' }, children: [_jsx("button", { onClick: togglePause, style: {
                                width: '52px',
                                height: '52px',
                                borderRadius: '50%',
                            ...
                            }, children: isPaused ? _jsx(Play, { size: 22, fill: "#F59E0B" }) : _jsx(Pause, { size: 22, fill: "#F59E0B" }) }), _jsx("button", { onClick: handleStopAndSave, disabled: saving, style: {
                                width: '64px',
                                height: '64px',
                                borderRadius: '50%',
                            ...
                            }, children: _jsx(Square, { size: 24, fill: "#FFFFFF" }) })] })] }) }));
};
