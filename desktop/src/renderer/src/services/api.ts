...
export class ApiService {
   ...
   */
  static async createMeeting(meetingData: Partial<IMeeting>): Promise<IMeeting | null> {
    try {
   ...
   */
  static async toggleStar(meetingId: string, currentStarred: boolean): Promise<boolean> {
    try {
   ...
   */
  static async searchSemantic(query: string): Promise<ISearchResult[]> {
    try {
